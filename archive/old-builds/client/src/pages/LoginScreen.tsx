              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="pl-0 pr-11 h-11 text-gray-900 bg-white border-gray-300 focus:border-blue-500 focus:ring-blue-500 focus:ring-1"
                    style={{ 
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="pl-0 pr-20 h-11 text-gray-900 bg-white border-gray-300 focus:border-blue-500 focus:ring-blue-500 focus:ring-1"
                      style={{ 
                        backgroundColor: 'white !important',
                        color: '#1f2937 !important'
                      }}
