...
export function CalendarScreen({ onNavigate }: CalendarScreenProps) {
  ...
  return (
    <div className="p-4 pb-24 max-w-md mx-auto animate-fade-in">
      {/* Header with food imagery - Brand Guidelines Compliant */}
      <div className="relative mb-6 -mx-4 -mt-4">
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <h1 className="text-brand-heading" style={{ fontFamily: "'League Spartan', sans-serif", fontSize: "1.5rem", fontWeight: 700, lineHeight: 1.2 }}>
            Meal Calendar
          </h1>
      ...
      {selectedDateData ? (
        ...
        <div className="bg-card rounded-xl p-6 shadow-sm border border-border mb-4 text-center">
          ...
          <h3 className="text-brand-subheading" style={{ fontFamily: "'Work Sans', sans-serif", fontSize: "1rem", fontWeight: 600 }} className="mb-2">
            No meals logged
          </h3>
          <p className="text-brand-body" style={{ fontFamily: "'Quicksand', sans-serif", fontSize: "0.875rem", fontWeight: 400 }} className="text-muted-foreground mb-4">
