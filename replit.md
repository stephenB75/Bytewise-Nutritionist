...
- **Expanded Hero Background Collection (August 5, 2025)**: Expanded hero background rotation from 20 to 33 images using more food assets from the 106 available images. Added chicken variations, desserts, fruits, and specialty foods for greater visual variety. Updated page-specific image mapping to include new food categories while maintaining thematic consistency across different app sections.
