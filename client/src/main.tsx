...
if (!rootElement) {
  ...
  try {
    ...
    rootElement.innerHTML = `
      <div style="background: linear-gradient(135deg, #1e293b, #0f172a); color: white; padding: 40px; min-height: 100vh; display: flex; align-items: center; justify-content: center; font-family: system-ui, -apple-system, sans-serif; text-align: center; position: relative; overflow: hidden;">
        <!-- Background pattern -->
        <div style="position: absolute; inset: 0; opacity: 0.1; background-image: radial-gradient(circle at 25% 25%, #7dd3fc 0%, transparent 50%), radial-gradient(circle at 75% 75%, #f59e0b 0%, transparent 50%);"></div>
        
        <div style="position: relative; z-index: 10;">
          <!-- CSS Logo -->
          <div style="margin-bottom: 3rem; text-align: center;">
            <div style="font-family: 'League Spartan', -apple-system, BlinkMacSystemFont, sans-serif; font-size: 5rem; font-weight: 900; margin: 0; line-height: 0.85; color: #7dd3fc; margin-bottom: 0.75rem; text-transform: lowercase; letter-spacing: -0.03em; text-shadow: 0 0 30px rgba(125, 211, 252, 0.3);">
              bytewise
            </div>
          ...
          <div style="margin-bottom: 2rem;">
            ...
            <div style="width: 60px; height: 60px; border: 3px solid rgba(125, 211, 252, 0.2); border-top: 3px solid #7dd3fc; border-radius: 50%; animation: spin 1.2s linear infinite; margin: 0 auto; box-shadow: 0 0 20px rgba(125, 211, 252, 0.3);"></div>
          </div>
        </div>
      </div>
