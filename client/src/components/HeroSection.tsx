...
export function HeroSection({ 
  ...
  return (
    <div className={`relative bg-gradient-to-br from-[var(--pastel-blue)] to-[var(--pastel-blue-dark)] text-white px-4 py-6 overflow-hidden ${className}`} style={{ marginTop: '88px' }}>
