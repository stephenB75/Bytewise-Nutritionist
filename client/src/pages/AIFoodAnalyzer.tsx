...
export default function AIFoodAnalyzer() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6" data-testid="page-ai-food-analyzer">
      {/* Header */}
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-yellow-500">{analysisResult.totalNutrition.protein}g</div>
