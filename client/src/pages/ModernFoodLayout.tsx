...
export default function ModernFoodLayout({ onNavigate }: ModernFoodLayoutProps) {
      ...
      <Card className="bg-amber-100 border-none p-5 transition-all duration-300 hover:bg-gradient-to-br hover:from-amber-100 hover:to-amber-200 shadow-lg hover:shadow-xl" data-testid="progress-card">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-gray-950 font-bold">{title}</h3>
      ...
      <Card className={`bg-gradient-to-br from-amber-100 to-cyan-100 border-none p-6 transition-all duration-300 hover:from-amber-100 hover:to-cyan-200 shadow-lg hover:shadow-xl ${isGoalReached ? 'ring-2 ring-cyan-500/50' : ''}`} data-testid="water-card">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-gray-950 font-bold text-lg">Water Intake</h3>
              <p className="text-gray-900 text-sm font-medium">{glasses}/{dailyGoal} glasses today</p>
            </div>
          </div>
          <div className="text-right">
            <div className="text-2xl font-bold text-gray-950">{Math.round(percentage)}%</div>
            <div className="text-xs text-gray-900 font-semibold">of goal</div>
          </div>
        </div>
  ...
  const MacroCard = React.memo(({ name, value, goal, color, data = [0, 0, 0, 0, 0] }: {
    ...
    const labelColor = isNegative ? 'text-red-600' : 'text-gray-950';
  ...
  const MicronutrientCard = ({ name, value, goal, unit, color }: {
    ...
    <Card className="bg-amber-100 border-none p-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-gradient-to-br hover:from-amber-100 hover:to-amber-200" data-testid="micro-card">
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="text-xs text-gray-950 font-bold">{displayValue}{unit} / {goal}{unit}</div>
      </div>
      ...
      <div className="text-xs text-gray-950 font-bold mt-1">{percentage}% Daily Value</div>
    </Card>
    );
  };
