  ...
  const renderHome = () => (
    <div className="space-y-0 page-container">
      ...
      <div className="px-6 py-8 bg-black content-section">
        ...
        <div className="space-y-6 force-bottom-spacing" style={{ paddingBottom: '12rem !important' }}>
          ...
          <div className="grid grid-cols-3 gap-4 force-bottom-spacing" style={{ marginBottom: '10rem !important', paddingBottom: '5rem !important' }}>
