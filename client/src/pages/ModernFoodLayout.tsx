          ...
          <div className="space-y-8 max-w-2xl">
            ...
            <div className="pt-8 animate-fadeInUp [animation-delay:0.8s]">
              <Button 
                ...
                size="lg"
                className="group relative bg-gradient-to-r from-orange-400 to-red-400 hover:from-orange-500 hover:to-red-500 font-black px-16 py-6 rounded-full text-xl md:text-2xl shadow-2xl transition-all duration-300 overflow-hidden btn-hero-enhanced"
